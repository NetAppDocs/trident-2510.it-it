...
summary: È possibile utilizzare il selettore di versione per navigare tra la versione più recente e le quattro versioni precedenti o utilizzare i link sottostanti. 
---
...
[role="lead"]
Se non si utilizza Trident 25.10, la documentazione per le versioni precedenti è disponibile in base al link:get-help.html["Ciclo di vita del supporto Trident"].
