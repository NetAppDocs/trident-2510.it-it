...
+-------------+-----------+--------+-----------------+--------------------------+-------------+
----
. Ripristinare l'applicazione nel cluster di destinazione utilizzando il nome AppVault e il percorso di archivio: NOTA: quando si utilizza una CR, assicurarsi che lo spazio dei nomi destinato al ripristino dell'applicazione esista nel cluster di destinazione.
